...
public class Jogador : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        cabeca.rotation = Quaternion.Lerp(cabeca.rotation, Quaternion.LookRotation(olharMira.position - camPos), deltaT * olharSpeed);
        //Mover o agente na velocidade moverSpeed na direcao da mira, relativo a rotacao da cabeca
        navAgent.velocity = (moverMira.position - camPos).normalized * (moverSpeed);
    }
